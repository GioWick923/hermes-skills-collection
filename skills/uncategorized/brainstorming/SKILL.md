---
name: brainstorming
description: "Use BEFORE any creative implementation work—creating new features, building components from scratch, or architecting new systems. Activates ONLY when user explicitly mentions 'brainstorm', 'design this from scratch', 'architect a new feature', or 'plan a new component'. Does NOT activate for bug fixes, typos, or minor tweaks to existing code."
version: "1.0.0"
license: MIT
metadata:
  hermes:
    ...
    required_commands: []
    usage_hint: "Trigger only on: brainstorm, design from scratch, architect new feature, plan new component. NOT for: fix, bug, typo, edit existing"
---
