...
description: "Anti-slop frontend skill for landing pages, portfolios, and redesigns ONLY. Activates when user says: 'landing page', 'portfolio', 'redesign website', 'make it look like Linear/Awwwards', 'create a premium UI'. Does NOT activate for: dashboards, data tables, admin panels, forms, or generic CSS fixes."
version: "1.0.0"
metadata:
  hermes:
    tags: [design, frontend, ui, landing-page, portfolio, redesign]
    required_environment_variables: []
    usage_hint: "Trigger only on: landing page, portfolio, redesign, premium UI. NOT for: dashboard, admin, forms, bug fixes"
---
