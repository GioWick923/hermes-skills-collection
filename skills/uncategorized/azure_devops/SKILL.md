---
name: azure_devops
description: Azure DevOps operations via the Azure DevOps API using AZURE_DEVOPS_TOKEN and curl. Manage repos, PRs, pushes, pipelines. Trigger keywords: azure devops, azure_devops, AZURE_DEVOPS_TOKEN, dev.azure.com, push to azure. (Ported from OpenHands skills/ microagent.)
---
