---
name: ui-ux-pro-max
description: "Use when designing, building, or reviewing UI/UX."
version: 2.13.0
author: NextLevelBuilder (portado a Hermes desde ui-ux-pro-max-skill, MIT)
license: MIT
platforms: [linux, macos, windows]
metadata:
  hermes:
    tags: [ui, ux, design, design-system, frontend, tailwind, react, shadcn, mobile, desktop]
    related_skills: [claude-design, sketch, popular-web-designs, frontend-ui-engineering, omh-frontend, design-taste-evolution, design-taste-frontend, high-end-visual-design]
---

# UI/UX Pro Max

> **Evolución 2026-09-01:** Este skill se fusiona con `design-taste-evolution`
> (que integra Leonxlnx/taste-skill). Para diseño de UI nuevo, carga
> `design-taste-evolution` como punto de entrada: usa este skill para **datos**
> (paletas/fonts/stacks/a11y) y taste-skill para **dirección anti-slop**.

Design intelligence para construir UIs profesionales. **Datos locales consultables** (stdlib Python, sin red):
79 estilos, 192 paletas con perfiles de razonamiento, 74 font pairings, 119 UX guidelines, 25 charts, 22 stacks.
Scripts: `scripts/search.py` (búsqueda), `scripts/design_system.py` (generador de design systems).

Portado y verificado 2026-08-27 desde `nextlevelbuilder/ui-ux-pro-max-skill` v2.13.0 (MIT, 122k★).

# UI/UX Pro Max (Hermes port)

UI/UX design intelligence for web, mobile, and desktop: 79 styles, 192 palettes, 74 font pairings, 119 UX guidelines, 25 chart types, 22 stacks.
> Quick Reference completo (checklists por prioridad, accesibilidad, layout, motion, forms, charts): `references/quick-reference.md`
