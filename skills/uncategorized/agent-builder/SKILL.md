---
name: agent-builder
description: Interview the user progressively (one question at a time) to gather requirements and build a custom agent, then research the OpenHands Software Agent SDK and produce a technical design. Trigger keywords: agent builder, build agent, create agent, interview requirements, agent design. (Ported from OpenHands skills/ microagent.)
---
