---
name: onboarding
description: First-time user interview (<=5 progressive questions) to identify coding goal and constraints, then generate a concrete PR-ready step-by-step plan. Trigger keywords: onboarding, first time, new user, plan a PR, start project. (Ported from OpenHands skills/ microagent.)
---
