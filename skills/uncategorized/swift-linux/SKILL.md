---
name: swift-linux
description: Step-by-step guide to install Swift on Debian 12 (Bookworm) Linux for non-UI development, including dependencies and toolchain setup. Trigger keywords: swift, install swift, swift linux, debian, swift toolchain. (Ported from OpenHands skills/ microagent.)
---
